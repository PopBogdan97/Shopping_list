...
<html>
    ...
    <body class="bg-success">
        ...
        <img src=<c:out value="${UserResource.getImage(email)}"/>  id="myImg" class="rounded-circle mx-auto d-block" width="300" height="300" data-toggle="modal" data-target="#searchModal" style="cursor: pointer;">
        <br><br>
